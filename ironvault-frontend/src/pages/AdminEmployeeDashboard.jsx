...
export const AdminEmployeeDashboard = () => {
  ...
  const handleLockToggle = async (userId, isLocked) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Failed to update employee lock status');
    } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-navy-50 to-teal-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-navy-600">Manage all employees and their status</p>
        </motion.div>
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search employees by email or username..."
                ...
                {users.length === 0 ? (
                  <tr>
                    <td colSpan="7" className="px-6 py-12 text-center">
                      ...
                      <p className="text-navy-600">No employees found</p>
                    </td>
                  </tr>
                ) : (
                  users.map((u, idx) => (
