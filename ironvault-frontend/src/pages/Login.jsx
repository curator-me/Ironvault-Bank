  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) { 
      if (result.role === 'ADMIN') {
        console.log("Succesful attempt: " + email + " as " + result.role);
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-navy-50">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-navy-900">Sign in to IronVault</h2>
          <p className="text-navy-500 text-sm mt-1">Access your secure financial dashboard</p>
        </div>
